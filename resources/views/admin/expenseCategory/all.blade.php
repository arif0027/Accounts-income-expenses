          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-md-4 card_button_part">
                    <a href="{{ url('dashboard/expenseCategory/add') }}" class="btn btn-sm btn-dark"><i class="fas fa-plus-circle"></i>Add Expense Category</a>
                </div>
            </div>
          </div>
          <div class="card-body">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="{{ url('dashboard/expenseCategory/view/'.$data->expcate_slug) }}">View</a></li>
                                <li><a class="dropdown-item" href="{{ url('dashboard/expenseCategory/edit/'.$data->expcate_slug) }}">Edit</a></li>
...
<div class="modal fade" id="softDeleteModal" tabindex="-1" aria-labelledby="softDeleteModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="{{ url('dashboard/expenseCategory/softdelete') }}" method="POST">
            @csrf
