              ...
              <tbody>
                @foreach ($all as $data)
                    <tr>
                        ...
                        <td>
                            <a href="#" id="restore" data-bs-toggle="modal" data-bs-target="#restoreModal" data-id="{{ $data->income_id }}"><i class="fas fa-solid fa-recycle fs-5 text-success fw-bold mx-1"></i></a>
