            ...
            <div class="card mb-3">
              <div class="card-header">
                <div class="row">
                    <div class="col-md-8 card_title_part">
                        <i class="fab fa-gg-circle"></i>Update Role Information
                    </div>
              ...
              <div class="card-body">
                  ...
                  <div class="row mb-3 {{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <div class="col-sm-7">
                      <input type="hidden" name="id" value="{{$data->role_name}}"/>
                      <input type="hidden" name="slug" value="{{$data->role_slug}}"/>
                      <input type="text" class="form-control form_control" id="" name="name" value="{{$data->role_name}}">
                      @if ($errors->has('name'))
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control form_control" id="" name="remarks" value="{{$data->role_remarks}}">
